...
- **HSR Support**: High-availability Seamless Redundancy RedBox SAN configuration
- **PRP Support**: Parallel Redundancy Protocol RedBox Mode 1 configuration
...
- **winpcap/npcap:**
    ...
    - **2** Create new folder as winpcap inside lib and pextract the conent of downloaded winpcap
    - **3** npcap needs to be installed. You can install it through Wireshark. When installing NPCAP, ensure that the Install Npcap in WinPcap API-compatible Mode check box is selected.
